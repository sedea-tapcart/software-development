...
## Pin promotion forbidden (binding)

**`create-pr`** opens PRs for **implementation diffs** on the active **`coding-session`** worktree branch only (source files, tests, config — not gitlink-only pointer bumps).
